#' Fit Zero-Inflated Continuous Bayesian Causal Forests (ZIC-BCF) -- Path A
#'
...
#'
#' @return A list of class \code{"zicbcf_fit_pathA"} with draws.
#' @export
zicbcf_pathA <- function(
    y, z,
